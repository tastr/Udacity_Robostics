...
if("FALSE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/robond/Udacity_Robotics/catkin_ws/src/main)
  set(main_DEVEL_PREFIX /home/robond/Udacity_Robotics/catkin_ws/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/robond/Udacity_Robotics/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'robond <robond@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/Udacity_Robotics/catkin_ws/install/${idir}'.  Ask the maintainer 'robond <robond@todo.todo>' to fix it.")
    endif()
